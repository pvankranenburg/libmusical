...
#ifndef NLBEXACTPITCH40IMASIMILARITYRATER_H_
#define NLBEXACTPITCH40IMASIMILARITYRATER_H_
 ...
 */
class NLBExactPitch40IMASimilarityRater: public musical::SimilarityRater {
public:
	/**
	 * Constructor
	 */
	NLBExactPitch40IMASimilarityRater();

	/**
	 * Destructor
	 */
	virtual ~NLBExactPitch40IMASimilarityRater();
	...
	virtual std::string getName() { return "NLBExactPitch40IMASimilarityRater"; };

};

}

#endif /* NLBEXACTPITCH40IMASIMILARITYRATER_H_ */
