...
#ifndef NLBIMAAFFINEGAPRATER_H_
#define NLBIMAAFFINEGAPRATER_H_
 ...
 */
class NLBIMAAffineGapRater: public AffineGapRater {
public:
	/**
	 * Constructor.
	 * Sets all gap scores to 0.0
	 */
	NLBIMAAffineGapRater();
	 ...
	 */
	NLBIMAAffineGapRater(double es);
	 ...
	 */
	NLBIMAAffineGapRater(double es, double ies);

	/**
	 * Destructor for NLBIMAAffineGapRater
	 */
	virtual ~NLBIMAAffineGapRater();
	...
	virtual std::string getName() { return "NLBIMAAffineGapRater"; }
