...
NLBMidiIntervalSimilarityRater::NLBMidiIntervalSimilarityRater() {
...
double NLBMidiIntervalSimilarityRater::getScore(Sequences * const seqs, const int x1, const int y1, const int x2, const int y2) const {
	...
	NLBSymbol * s2prev = static_cast<NLBSymbol *>(s2->getPrevious());
